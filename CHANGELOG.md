...
## [Unreleased](https://github.com/orisai/nette-monolog/compare/1.3.1...v1.x)

### Changed

- Tracy to PSR bridge - custom levels are mapped to info instead of error if the logged value is not an exception
